...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GroupBox2.Size = New System.Drawing.Size(320, 46)
        Me.GroupBox2.TabIndex = 17
        Me.GroupBox2.TabStop = False
        Me.GroupBox2.Text = "Destination File"
        '
        'Button2
        '
        ...
        Me.TextBox2.Text = "C:\test_copy.txt"
        '
        'GroupBox4
        '
        ...
        Me.GroupBox4.Size = New System.Drawing.Size(320, 46)
        ...
        Me.SaveFileDialog1.Title = "Destination File"
        '
        'Label1
        '
        ...
        Me.Label1.Text = "Build: 20060216.3"
        '
        'Config
        '
...
#End Region
    ...
    Private Sub Error_Handler(ByVal message As String)
        ...
        Catch ex As Exception
            MsgBox("An error occurred in Continuous File Copier's error handling routine. The application will try to recover from this serious error.", MsgBoxStyle.Critical, "Critical Error Encountered")
        End Try
    End Sub
    ...
    Public Sub Load_Registry_Values()
        Try
            ...
            For Each str In keys
                If str.Equals("Software\Continuous File Copier") = True Then
                    keyflag1 = True
                    Exit For
                End If
            Next str
            ...
            If keyflag1 = False Then
                oReg.CreateSubKey("Software\Continuous File Copier")
            End If

            keyflag1 = False

            Dim oKey As RegistryKey = oReg.OpenSubKey("Software\Continuous File Copier", True)

            str = oKey.GetValue("sourcefile")
            If Not IsNothing(str) And Not (str = "") Then
                sourcefile = str
            Else
                configflag = True
                oKey.SetValue("sourcefile", "C:\test.txt")
            ...
            str = oKey.GetValue("destinationfile")
            If Not IsNothing(str) And Not (str = "") Then
                destinationfile = str
            Else
                configflag = True
                oKey.SetValue("destinationfile", "C:\test_copy.txt")
                destinationfile = "C:\test_copy.txt"
            End If
    ...
    Private Sub Save_Registry_Values()
        Try
            ...
            oKey.SetValue("sourcefile", TextBox1.Text)
            oKey.SetValue("destinationfile", TextBox2.Text)
    ...
    Private Sub button1_click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            ...
            End If
        Catch ex As Exception
            Error_Handler("An """ & ex.Message & """ error occurred while loading open file dialog. The program will attempt to recover shortly.")
        End Try
    End Sub
